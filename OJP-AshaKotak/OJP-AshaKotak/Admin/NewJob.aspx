<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="OJP_AshaKotak.Admin.NewJob" %>
        ...
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex. 10000/Month, 25000/Month, 7L/Year" required></asp:TextBox>
                </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    ...
                    <asp:FileUpload ID="fuCompanyLogo" runat="server" CssClass="form-control" ToolTip=".jpg, png, jpeg extention only" />
