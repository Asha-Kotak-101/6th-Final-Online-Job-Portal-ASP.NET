    ...
    public partial class NewJob : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(Request.QueryString["id"] != null)
                {
                    ...
                    if (fuCompanyLogo.HasFile)
                    {
                        if (Utils.isValidExtension(fuCompanyLogo.FileName))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@ComapanyImage", imagePath);
                            isValidToExecute = true;
                        }
                        else
                        {
                            lblMsg.Text = "Please Select The .jpg, .png, .jpeg File For Logo";
                            lblMsg.CssClass = "alert alert-danger";
                        }
                    }
                    else
                ...
                {
                    query = @"Insert into Jobs values(@Title, @NoOfPost, @Description, @Qualification, @Experience, @Specialization, @LastDateToApply, @Salary, @JobType, @CompanyName, @ComapanyImage, @Website, @Email, @Address, @Country, @State, @CreateDate)";
                    type = "Saved";
