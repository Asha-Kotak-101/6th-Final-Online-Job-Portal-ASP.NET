<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="OJP_AshaKotak.User.JobListing" %>
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-job-items2">
                                    <asp:DropDownList ID="ddlCountry" runat="server"
                                        name="select" CssClass="form-control w-100"
                                    ...
                                    <div class="radiobuttoncontainer">
                                        ...
                                        <asp:RadioButtonList ID="RadioButtonList1"
                                            ...
                                            <asp:ListItem Value="0"
                                                Selected="True">Any</asp:ListItem>
                                            <asp:ListItem
