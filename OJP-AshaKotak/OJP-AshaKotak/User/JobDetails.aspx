<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobDetails.aspx.cs" Inherits="OJP_AshaKotak.User.JobDetails" %>
                        ...
                        <div class="single-job-items mb-50">
                            <div class="job-items">
                                <div class="company-img company-img-details">
                                   <a href="#">
    <img width="80" src='<%#GetImageUrl(Eval("CompanyImage").ToString())%>' alt="">
</a>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="post-details3  mb-50">
                          ...
                          <ul>
                              ...
                              <li>Last Date To Apply : <span> <%# DataBinder.Eval(Container.DataItem, "LastDateToApply", "{0:dd MMMM yyyy}") %></span></li>
                          </ul>
